    ...
    },
{
  ...
  /* Casual and headline phrasings count as questions too. "wat to eat after gym" and "best
     time to eat protein" were read as commands to log food -- they contain "eat", and the
     opener list wanted a tidy "what" or "should i". Someone asking WHAT to eat is not
     telling the app they ate it, and answering that with a food-log write is the exact
     complaint that this does not understand how people talk. */
  var QUESTION_OPENER = /^(how many|how much|how do|how often|how to|what|whats|what to|which|when|where|why|best|top|good|any|is|are|does|did i|do i|have i|am i|is my|is it|can i|should i|could i|would i|will i|tell me|show|suggest|recommend)\b/;
