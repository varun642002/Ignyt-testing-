 ...
 *
 * Phone/SMS remains removed — it could not send a message until Play Integrity succeeded and
 * asked a Play reviewer for a number they have no reason to give. Google Sign-In has neither
 * problem: it needs the certificate registered, which it now is for all three signing keys.
 *
