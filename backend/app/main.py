...
from .api import routes_ai, routes_auth, routes_billing, routes_health
...
def create_app() -> FastAPI:
    ...
    app.include_router(routes_ai.router, prefix=prefix)
    app.include_router(routes_billing.router, prefix=prefix)
